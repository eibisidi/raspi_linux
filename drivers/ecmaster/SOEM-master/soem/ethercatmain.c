 ...
 */
void ecx_pushindex(ecx_contextt *context, uint8 idx, void *data, uint16 length, uint16 DCO)
{
 ...
 */
int ecx_pullindex(ecx_contextt *context)
{
   int rval = -1;
 ...
 */
void ecx_clearindex(ecx_contextt *context)  {
